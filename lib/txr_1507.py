...
def build_signwell_fields_txr1507(data, *, client_count=1):
    ...
    fields.extend([
        {"api_id": f"txr1507_{role}_signature_p2", "type": "signature", "page": 2, "x": 70, "y": 666, "recipient_id": role, "required": True, "width": 190, "height": 26},
        {"api_id": f"txr1507_{role}_date_p2", "type": "date", "page": 2, "x": 270, "y": 666, "recipient_id": role, "required": True, "width": 88, "height": 20, "date_format": "MM/DD/YYYY", "lock_sign_date": True},
    ])
    return [fields]
