...
(() => {
  ...
  const renderInstallCard = () => {
    ...
    const title = formLibrarySurface ? 'Keep the Texas form library one tap away' : 'Keep HomeOfferFlow one tap away';
    const copy = formLibrarySurface ? 'Install the lightweight app shell to return quickly to the shared form guide and Question 1.' : 'Install the lightweight app shell for faster returns to your workspace.';
