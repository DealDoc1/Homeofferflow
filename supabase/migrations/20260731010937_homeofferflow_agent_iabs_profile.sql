...
-- Apply with the agent IABS profile release. The bucket is private and every
-- browser policy is limited to the authenticated user's own folder.
...
-- Verification query: confirms the private agent document table and bucket.
