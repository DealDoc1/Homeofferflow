...
values
  ('trec-20-19-buyer-offer', 'Forms', 'TREC 20-19 buyer offer workflow', 'Controlled production launch of the July 2026 Texas one-to-four family contract and verified buyer packet paths.', 1, 'production', 'production', 'passed', null, '773732d [deploy-production] Promote verified HomeOfferFlow release', null, 'Continue gated expansion without moving locked coordinates.', 'main', true, '{"coverage":"cash, conventional, FHA, VA, USDA and ten golden scenarios"}'),
  ('seller-temporary-lease', 'Forms', 'Seller Temporary Residential Lease', 'Support TREC 15-7 when the seller remains temporarily after closing.', 2, 'production', 'production', 'passed', null, '08272d6 Release seller temporary lease execution', null, 'Run the seller-temporary-lease scenario in the golden regression suite after any packet, signer, or production API change.', null, true, '{"form":"TREC 15-7","packet_pages":14}'),
  ('txr-1507-short-buyer-tenant-representation', 'Forms', 'TXR-1507 Residential Buyer/Tenant Representation Agreement - Short Form', 'Agent-selected Texas REALTORS® buyer or tenant representation agreement with dedicated signing and visual QA.', 3, 'planned', 'backlog', 'not_tested', 'Buyer relationship release', null, 'The form source has been reviewed; workflow, authorization gate, signatures, and rendered QA are not implemented.', 'Build the agent-selected Short Form workflow after the seller temporary lease staging release is completed.', null, false, '{"form":"TXR-1507","revision":"06-15-26","pages":2,"source_authorization":"Texas REALTORS member form"}'),
  ...
  ('buyer-temporary-lease', 'Forms', 'Buyer Temporary Residential Lease', 'Attach and sign the Buyer Temporary Residential Lease when possession requires it.', 8, 'production', 'production', 'passed', null, '773732d [deploy-production] Promote verified HomeOfferFlow release', null, 'Regression-test with the golden suite after related packet assembly changes.', 'main', true, '{}'),
  ...
  ('brokerage-branding', 'Brokerage', 'Brokerage branding', 'Logo, colors, disclaimer, contact information, and form/email defaults.', 28, 'in_progress', 'production', 'partial', 'Brokerage release', 'Secure upload and signing-message identity implemented', 'Broker-admin-only logo upload and brand-color editing are implemented, and brokerage identity appears in generated signing messages. Rendered-packet branding and authenticated broker-admin QA remain outstanding.', 'Run authenticated broker-admin QA for logo upload, color saving, shared defaults, roster visibility, and one invitation; then verify rendered-packet branding before marking complete.', null, false, '{}'),
  ...
  ('signwell-status-tracking', 'Signing', 'SignWell status tracking', 'Track awaiting signature, partially signed, and fully executed document status.', 30, 'production', 'production', 'passed', null, '773732d [deploy-production] Promote verified HomeOfferFlow release', null, 'Continue webhook and status-refresh monitoring.', 'main', true, '{}'),
...
values
  ...
  ('target-seller-temporary-lease', 'Seller Temporary Residential Lease', 'Targeted Addendum', 'Verify checkbox, packet assembly, every applicable blank, and signatures.', 'Seller temporary lease payload', 25, 'production', '08272d6 Release seller temporary lease execution', '{"form":"TREC 15-7"}', 'Fourteen-page completed packet passed field-by-field and signature review; retain recipient-order coverage.'),
...
values
  ('trec-20-19-controlled-launch', 'TREC 20-19 controlled production launch', 'production', 'deployed', 'passed', 'main', '773732de53792b031c09621e8ac275f42535bcc0', null, 'Promoted the verified buyer-offer paths and current brokerage/agent runtime to production behind the verified release gate.', 'Optional unverified paths remain blocked.', 'Continue targeted unlocks one path at a time.', 'Andrew Christian', now(), now()),
  ...
  ('seller-temporary-lease-unlock', 'Seller Temporary Residential Lease production unlock', 'production', 'deployed', 'passed', 'main', '08272d6', null, 'TREC 15-7 completed four-party packet passed field-by-field and completed-signature visual review; production recipient-order routing is enabled.', null, 'Retain the seller-temporary-lease scenario in every production regression run.', 'Andrew Christian', now(), now()),
