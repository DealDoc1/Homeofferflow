...
values
  ...
  ('founding-partner-pilot', 'Partners', 'Founding Partner Pilot', 'Public partner interest intake, market/category qualification, honest pilot positioning, and campaign attribution before paid placement activation.', 26, 'in_progress', 'staging', 'partial', 'Partner validation release', 'Application and server-side capture prepared', 'Live table migration, preview verification, and first partner qualification are still required.', 'Apply the partner-lead schema, deploy the public intake, and qualify the first title, lender, inspection, warranty, or insurance pilot.', null, false, '{"monetization_stage":"demand_validation","no_volume_promise":true}'),
