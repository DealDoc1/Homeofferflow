...
set
  current_release = 'Brokerage workspace preflight: active brokerage-admin account verified (2026-08-03)',
  known_issues = 'An active brokerage-admin account and active brokerage membership exist for the launch brokerage. Authenticated browser QA for branding, shared defaults, roster visibility, invitations, and packet/signing propagation remains outstanding.',
