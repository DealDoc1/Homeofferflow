...
STATUS_MAP = {
    ...
    "document_created": "Awaiting Signature",
    "document_create": "Awaiting Signature",
    "created": "Awaiting Signature",
...
def update_supabase(document_id, status, event_type, payload):
    ...
    with httpx.Client(timeout=20) as client:
        ...
        # Always log the webhook, even if no offer matched. This is important for debugging.
        if rows:
            for row in rows:
                event_payload = {
                    "offer_id": row.get("id"),
