...
def _rules_fallback(offer):
    ...
    return {
        "score": score,
        "summary": "Rules-based fallback review completed. Live Gemini review was unavailable, but HomeOfferFlow still checked common Texas offer-strength factors.",
        "risks": risks[:6],
...
RESPONSE_SCHEMA = {
    ...
    "required": ["score", "summary", "risks", "strengths", "marketContext", "suggestions", "disclaimer"]
}
        ...
        try:
            ...
            prompt = {
                ...
                "instructions": [
                    ...
                    "Do not invent MLS, DOM, comps, list-price history, or market statistics. If not provided, say live market scoring needs MLS/comps data.",
