        ...
        try:
            ...
            prompt = {
                ...
                "instructions": [
                    ...
                    "Generate an OFFER COMPETITIVENESS score (1-100), not a contract quality score. The score should represent how attractive this offer is to a typical seller for THIS property in THIS market.", "Market conditions should influence the score more than contract mechanics.", "The same offer may score very differently on two properties with different DOM, price reductions, inventory conditions, or seller leverage.",
