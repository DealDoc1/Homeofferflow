...
def build_signwell_fields(offer, pdf_bytes):
    ...
    if has_financing_addendum and page_count >= 13:
        ...
        # Financing addendum signature page buyer signature lines near bottom.
        add_field(
...
def create_signwell_signature_request(offer, pdf_bytes):
    ...
    payload = {
        ...
        "metadata": {
            ...
            "debug_payload": "bundle_main_initials_financing"
        }
    }
    ...
    try:
        ...
        if ok:
            return {
                "enabled": True,
                "ok": True,
                "mode": "bundle_main_initials_financing",
                "test_mode": SIGNWELL_TEST_MODE,
        ...
        return {
            "enabled": True,
            "ok": False,
            "mode": "bundle_main_initials_financing_failed",
            "test_mode": SIGNWELL_TEST_MODE,
            "field_count": len(fields[0]) if fields else 0,
            "signwell_error": data
        }
