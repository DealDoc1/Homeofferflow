...
def build_signwell_fields(offer, pdf_bytes):
    ...
    if has_financing_addendum and page_count >= 13:
        ...
        # v10: user screenshot direction - move financing page 12 initials up/left.
        add_field(
        ...
        # v10: user screenshot direction - move financing page 13 signature/date left/up slightly.
        add_field(
