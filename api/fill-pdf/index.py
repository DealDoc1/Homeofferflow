...
def build_signwell_fields(offer, pdf_bytes):
    ...
    - Main contract initials on pages 1-8 only. Buyer 2 main initials shifted right; Buyer 2 signature/addenda coordinates adjusted from two-buyer QA.
    ...
    if has_buyer2:
        add_sig_date_pair("buyer2_main_contract", main_signature_page, 115, 646, 286, 646, "2")
    ...
    if financing_page_1 and financing_signature_page:
        ...
        if has_buyer2:
            add_sig_date_pair("buyer2_financing_addendum", financing_signature_page, 112, 914, 266, 914, "2")

    # HOA/POA Addendum - buyer signatures only. No seller fields.
    if hoa_page:
        add_sig_date_pair("buyer1_hoa_addendum", hoa_page, 112, 780, 266, 780, "1")
        if has_buyer2:
            add_sig_date_pair("buyer2_hoa_addendum", hoa_page, 112, 930, 266, 930, "2")
    ...
    if sale_page:
        ...
        if has_buyer2:
            add_sig_date_pair("buyer2_sale_other_property_addendum", sale_page, 112, 792, 266, 792, "2")
