...
def build_signwell_fields(offer, pdf_bytes):
    ...
    - Main contract initials on pages 1-8 only.
    ...
    if has_buyer2:
        add_sig_date_pair("buyer2_main_contract", main_signature_page, 115, 632, 286, 632, "2")
    ...
    for page in main_contract_pages:
        ...
        if has_buyer2:
            add_field(f"buyer2_initials_main_p{page}", "initials", page, 322, 1018, recipient_id="2", width=24, height=10)
    ...
    if financing_page_1 and financing_signature_page:
        ...
        if has_buyer2:
            add_field("buyer2_initials_financing_p1", "initials", financing_page_1, 314, 1004, recipient_id="2", width=24, height=10)
        # User requested financing fields left/up vs prior bundle.
        add_sig_date_pair("buyer1_financing_addendum", financing_signature_page, 112, 802, 266, 802, "1")
        if has_buyer2:
            add_sig_date_pair("buyer2_financing_addendum", financing_signature_page, 112, 860, 266, 860, "2")

    # HOA/POA Addendum - buyer signatures only. No seller fields.
    if hoa_page:
        add_sig_date_pair("buyer1_hoa_addendum", hoa_page, 112, 780, 266, 780, "1")
        if has_buyer2:
            add_sig_date_pair("buyer2_hoa_addendum", hoa_page, 112, 842, 266, 842, "2")

    # Sale of Other Property Addendum - buyer signatures only. No seller fields.
    if sale_page:
        add_sig_date_pair("buyer1_sale_other_property_addendum", sale_page, 112, 760, 266, 760, "1")
        if has_buyer2:
            add_sig_date_pair("buyer2_sale_other_property_addendum", sale_page, 112, 824, 266, 824, "2")
