...
def build_signwell_fields(offer, pdf_bytes):
    ...
    if has_buyer2:
        add_sig_date_pair("buyer2_main_contract", main_signature_page, 115, 654, 286, 654, "2")
    ...
    if financing_page_1 and financing_signature_page:
        ...
        if has_buyer2:
            add_sig_date_pair("buyer2_financing_addendum", financing_signature_page, 112, 902, 266, 902, "2")

    # HOA/POA Addendum - buyer signatures only. No seller fields.
    if hoa_page:
        add_sig_date_pair("buyer1_hoa_addendum", hoa_page, 112, 817, 266, 817, "1")
        if has_buyer2:
            add_sig_date_pair("buyer2_hoa_addendum", hoa_page, 112, 922, 266, 922, "2")

    # Sale of Other Property Addendum - buyer signatures only. No seller fields.
    if sale_page:
        add_sig_date_pair("buyer1_sale_other_property_addendum", sale_page, 112, 769, 266, 769, "1")
        if has_buyer2:
            add_sig_date_pair("buyer2_sale_other_property_addendum", sale_page, 112, 786, 266, 786, "2")
