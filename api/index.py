...
def build_signwell_fields(offer, pdf_bytes):
    ...
    # v9: buyer initials moved farther right onto the actual blank after the printed Buyer label.
    ...
    if has_financing_addendum and page_count >= 13:
        ...
        # v11: financing page 12 initials moved slightly farther left/up per QA screenshot.
        add_field(
        ...
        # v11: financing page 13 buyer signature/date moved farther left/up per QA screenshot.
        add_field(
