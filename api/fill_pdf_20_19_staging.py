...
def build_pages_data(
    ...
    pages[4] = [
        ...
        (62,  727, ck(as_is == "yes"), "check_small"),
        ...
        *wrapped_entries(89, 694, s.get("repairsText", "") if as_is == "repairs" else "", max_chars=88, line_gap=10, fs=7, max_lines=3),
        ...
        (427, 275, str(water_days) if water_disc in ["notreceived", "not_received", "no", ""] else ""),
    ...
    pages[5] = [
        ...
        *wrapped_entries(95, 704, s.get("brokerDisclosure", ""), max_chars=105, line_gap=10, fs=7, max_lines=3),
        ...
        (356, 456, ck(possession == "funding"), "check_small"),
        (502, 456, ck(possession == "lease"), "check_small"),

        # 20-19 Paragraph 12A(1)(b): seller contribution to Buyer's Expenses, not brokerage compensation.
        (330, 164, fmt_money(concession_amount) if concession_amount else ""),
    ]
    ...
    pages[7] = [
        ...
        (142, 152, s.get("agentBrokerage", "") if has_buyer_agent else "", 7),
        (126, 82, s.get("agentPhone", "") if has_buyer_agent else "", 7),
        (126, 45, s.get("agentEmail", "") if has_buyer_agent else "", 7),
    ]
