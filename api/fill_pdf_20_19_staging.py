...
def build_pages_data(
    ...
    lead_required = val_lower(first_present(s.get("leadBuiltBefore1978"), s.get("leadBasedPaint"), s.get("leadRequired"))) in ["yes", "true", "1", "required"]
    ...
    pages[1] = [
        ...
        (153, 712, escrow_agent, 7),
        (75,  702, escrow_addr, 7),
        (293, 701, fmt_money(s.get("earnest", ""))),
        (488, 701, fmt_money(s.get("optionFee", ""))),
        ...
        (91, 497, str(s.get("optionDays", "7"))),

        (314, 353, ck(title_payer == "seller"), "check_small"),
        (369, 344, ck(title_payer == "buyer"), "check_small"),
        (285, 333, s.get("titleCompany", "Chicago Title DFW - Forgey Law Group PLLC")),
    ...
    pages[3] = [
        ...
        (424, 187, str(s.get("disclosureDays", "3")) if seller_disc == "notReceived" else ""),
    ]
    ...
    pages[4] = [
        ...
        (62,  723, ck(as_is == "yes"), "check_small"),
        (62,  715, ck(as_is == "repairs"), "check_small"),
        *wrapped_entries(89, 694, s.get("repairsText", "") if as_is == "repairs" else "", max_chars=88, line_gap=10, fs=7, max_lines=3),
        ...
        (432, 279, str(water_days) if water_disc in ["notreceived", "not_received", "no", ""] else ""),
    ...
    pages[5] = [
        ...
        *wrapped_entries(95, 704, s.get("brokerDisclosure", ""), max_chars=105, line_gap=10, fs=7, max_lines=3),
        ...
        (356, 452, ck(possession == "funding"), "check_small"),
        (502, 452, ck(possession == "lease"), "check_small"),

        # 20-19 Paragraph 12A(1)(b): seller contribution to Buyer's Expenses, not brokerage compensation.
        (278, 143, fmt_money(concession_amount) if concession_amount else ""),
    ]
    ...
    pages[7] = [
        ...
        (142, 157, s.get("agentBrokerage", "") if has_buyer_agent else "", 7),
        (126, 87, s.get("agentPhone", "") if has_buyer_agent else "", 7),
        (126, 50, s.get("agentEmail", "") if has_buyer_agent else "", 7),
    ]
    ...
    pages[8] = [
        ...
        # Financial
        (68, 662, ck(has_loan), "check_small"),
        (68, 646, ck(has_sale), "check_small"),
        (68, 630, ck(has_appraisal), "check_small"),
        ...
        # Other
        (68, 282, ck(has_hoa), "check_small"),
        (68, 263, ck(has_non_realty), "check_small"),
        (68, 248, ck(has_bkup), "check_small"),
    ]
...
def fill_and_merge(offer):
    ...
    if has_non_realty and os.path.exists(non_realty_pdf_path):
        ...
        non_realty_pages = {
            0: [
                (230, 628, addr_full, 8),
                (164, 536, fmt_money(first_present(s.get("nonRealtyAmount"), s.get("nonRealtyAdditionalSum"), "10")), 8),
...
def build_signwell_fields(offer, pdf_bytes):
    ...
    add_sig_date_pair("buyer1_main_contract", main_signature_page, 115, 442, 286, 442, "1")
    if has_buyer2:
