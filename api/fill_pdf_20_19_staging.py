...
def build_pages_data(
    ...
    pages[1] = [
        ...
        (153, 700, escrow_agent, 7),
        (75,  690, escrow_addr, 7),
        (293, 689, fmt_money(s.get("earnest", ""))),
        (488, 689, fmt_money(s.get("optionFee", ""))),

        (324, 639, fmt_money(additional_earnest) if has_positive_money(additional_earnest) else ""),
        (152, 625, str(first_present(s.get("additionalEarnestDays"), s.get("additionalEarnestDeadlineDays"))) if has_positive_money(additional_earnest) else ""),

        (86, 475, str(s.get("optionDays", "7"))),
    ...
    pages[2] = [
        ...
        (60,  631, ck(survey == "buyerNew"), "check_small"),
        (128, 632, str(s.get("surveyDays", "7")) if survey == "buyerNew" else ""),
    ...
    pages[3] = [
        ...
        (424, 207, str(s.get("disclosureDays", "3")) if seller_disc == "notReceived" else ""),
    ]
...
def build_signwell_fields(offer, pdf_bytes):
    ...
    add_sig_date_pair("buyer1_main_contract", main_signature_page, 115, 440, 286, 440, "1")
    if has_buyer2:
