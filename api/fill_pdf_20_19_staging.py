...
def build_pages_data(
    ...
    pages[3] = [
        ...
        (62,  143, ck(seller_disc == "exempt"), "check_small"),
    ...
    pages[4] = [
        ...
        *wrapped_entries(89, 697, s.get("repairsText", "") if as_is == "repairs" else "", max_chars=70, line_gap=7, fs=7.5, max_lines=2),
    ...
    if has_bkup and os.path.exists(BACKUP_PDF):
        ...
        bkup_pages = {
            0: [
                ...
                # 17X: Backup A(2) hard reset. Seat each value in the printed blanks rather than
                # allowing them to float in the body text.
                (347, 522, fmt_money(bkup_addl_earnest) if bkup_addl_earnest else "", 9),
                (86, 510, fmt_money(bkup_addl_option) if bkup_addl_option else "", 9),
                (317, 510, str(bkup_addl_days) if bkup_addl_days else "", 9),

                # 17X: Paragraph G First Contract date seated in the dated ___, 20___ blanks.
                (150, 220, bkup_first_md, 9),
                (325, 220, bkup_first_yy, 9),
