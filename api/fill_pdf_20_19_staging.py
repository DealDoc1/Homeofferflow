...
def build_pages_data(
    ...
    pages[2] = [
        ...
        (388, 512, str(first_present(s.get("objectionDays"), s.get("titleObjectionDays"))) if first_present(s.get("objectionDays"), s.get("titleObjectionDays")) else "", 10),
    ...
    pages[3] = [
        ...
        (62,  114, ck(seller_disc == "exempt"), "check_small"),
    ...
    pages[4] = [
        ...
        *wrapped_entries(89, 689, s.get("repairsText", "") if as_is == "repairs" else "", max_chars=70, line_gap=8, fs=7.5, max_lines=2),
        ...
        (340, 101, water_source if water_disc in ["notrequired", "not_required", "exempt"] else "", 7),
    ]
    ...
    pages[6] = [
        ...
        (62, 627, ck(buyer_12b_active), "check_small"),
        (286, 627, ck(buyer_12b_active and buyer_broker_comp_type == "amount"), "check_small"),
        (310, 625, fmt_money(buyer_broker_comp_amount) if buyer_12b_active and buyer_broker_comp_type == "amount" else "", 8),
        (390, 627, ck(buyer_12b_active and buyer_broker_comp_type == "percent"), "check_small"),
        (420, 625, str(buyer_broker_comp_percent) if buyer_12b_active and buyer_broker_comp_type == "percent" else "", 8),
    ]
    ...
    pages[10] = [
        ...
        # 17W: Buyer-only broker block reset again. Values sit just above the blank lines,
    ...
    if has_bkup and os.path.exists(BACKUP_PDF):
        ...
        bkup_pages = {
            0: [
                ...
                # 17W: Backup A(2) hard reset. Seat each value in the printed blanks rather than
                # allowing them to float in the body text.
                (335, 522, fmt_money(bkup_addl_earnest) if bkup_addl_earnest else "", 9),
                (78, 510, fmt_money(bkup_addl_option) if bkup_addl_option else "", 9),
                (282, 510, str(bkup_addl_days) if bkup_addl_days else "", 9),

                # 17W: Paragraph G First Contract date seated in the dated ___, 20___ blanks.
                (112, 236, bkup_first_md, 9),
                (333, 236, bkup_first_yy, 9),
