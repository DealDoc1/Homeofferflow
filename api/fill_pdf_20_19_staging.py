...
def build_pages_data(
    ...
    pages[1] = [
        ...
        (324, 651, fmt_money(additional_earnest) if has_positive_money(additional_earnest) else ""),
        (152, 637, str(first_present(s.get("additionalEarnestDays"), s.get("additionalEarnestDeadlineDays"))) if has_positive_money(additional_earnest) else ""),

        (86, 488, str(s.get("optionDays", "7"))),
    ...
    pages[2] = [
        ...
        (131, 625, str(s.get("surveyDays", "7")) if survey == "buyerNew" else ""),
    ...
    pages[3] = [
        ...
        (424, 197, str(s.get("disclosureDays", "3")) if seller_disc == "notReceived" else ""),
    ]
