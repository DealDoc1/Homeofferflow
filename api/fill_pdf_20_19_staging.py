...
def build_pages_data(
    ...
    pages[1] = [
        ...
        (153, 684, escrow_agent, 7),
        (75,  674, escrow_addr, 7),
        (293, 673, fmt_money(s.get("earnest", ""))),
        (488, 673, fmt_money(s.get("optionFee", ""))),

        (324, 623, fmt_money(additional_earnest) if has_positive_money(additional_earnest) else ""),
        (152, 609, str(first_present(s.get("additionalEarnestDays"), s.get("additionalEarnestDeadlineDays"))) if has_positive_money(additional_earnest) else ""),

        (86, 459, str(s.get("optionDays", "7"))),

        (314, 369, ck(title_payer == "seller"), "check_small"),
        (369, 355, ck(title_payer == "buyer"), "check_small"),
        (285, 344, s.get("titleCompany", "Chicago Title DFW - Forgey Law Group PLLC")),
    ...
    pages[2] = [
        ...
        (131, 635, str(s.get("surveyDays", "7")) if survey == "buyerNew" else ""),
    ...
    pages[3] = [
        ...
        (424, 227, str(s.get("disclosureDays", "3")) if seller_disc == "notReceived" else ""),
    ]
    ...
    pages[5] = [
        ...
        *wrapped_entries(95, 704, s.get("brokerDisclosure", ""), max_chars=105, line_gap=10, fs=7, max_lines=3),
        ...
        (250, 151, fmt_money(concession_amount) if concession_amount else ""),
    ]
...
def build_signwell_fields(offer, pdf_bytes):
    ...
    add_sig_date_pair("buyer1_main_contract", main_signature_page, 115, 452, 286, 452, "1")
    if has_buyer2:
