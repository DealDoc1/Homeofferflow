...
def build_pages_data(
    ...
    pages[1] = [
        ...
        (153, 704, escrow_agent, 7),
        (75,  694, escrow_addr, 7),
        (293, 693, fmt_money(s.get("earnest", ""))),
        (488, 693, fmt_money(s.get("optionFee", ""))),

        (324, 643, fmt_money(additional_earnest) if has_positive_money(additional_earnest) else ""),
        (152, 629, str(first_present(s.get("additionalEarnestDays"), s.get("additionalEarnestDeadlineDays"))) if has_positive_money(additional_earnest) else ""),
