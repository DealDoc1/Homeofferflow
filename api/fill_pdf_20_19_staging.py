...
def build_pages_data(
    ...
    pages[1] = [
        ...
        (153, 716, escrow_agent, 7),
        (75,  706, escrow_addr, 7),
        (293, 705, fmt_money(s.get("earnest", ""))),
        (488, 705, fmt_money(s.get("optionFee", ""))),
        ...
        (86, 491, str(s.get("optionDays", "7"))),

        (314, 353, ck(title_payer == "seller"), "check_small"),
        (369, 339, ck(title_payer == "buyer"), "check_small"),
        (285, 328, s.get("titleCompany", "Chicago Title DFW - Forgey Law Group PLLC")),
    ...
    pages[5] = [
        ...
        *wrapped_entries(95, 704, s.get("brokerDisclosure", ""), max_chars=105, line_gap=10, fs=7, max_lines=3),
        ...
        (250, 135, fmt_money(concession_amount) if concession_amount else ""),
    ]
