...
def build_signwell_fields(offer, pdf_bytes):
    ...
    # Live QA: both buyer SignWell fields were too low on TREC 57-0; move them up onto the Buyer lines.
    if non_realty_page:
        add_sig_date_pair("buyer1_non_realty_items_addendum", non_realty_page, 76, 758, 246, 758, "1")
        if has_buyer2:
            add_sig_date_pair("buyer2_non_realty_items_addendum", non_realty_page, 76, 805, 246, 805, "2")
