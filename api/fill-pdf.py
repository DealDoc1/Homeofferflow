...
def fill_and_merge(offer):
    ...
    if has_non_realty and os.path.exists(non_realty_pdf_path):
        ...
        non_realty_pages = {
            0: [
                (230, 648, addr_full, 8),
                (164, 604, fmt_money(first_present(s.get("nonRealtyAmount"), s.get("nonRealtyAdditionalSum"), "10")), 8),
                *wrapped_entries(62, 526, non_realty_description, max_chars=88, line_gap=11, fs=7, max_lines=12),
            ],
        }
