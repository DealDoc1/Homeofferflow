...
| Transaction follow-up | TXR-1503 Termination; TXR-1505 Amendment; TXR-1903 Amendment of Contract; TXR-1902 Notice of Buyer's Termination; TXR-1958 Critical Date List; TREC-62-0 Seller Notice of Removal of Backup-Contract Contingency | Build each remaining form with its own data model and regression scenario. TREC-62-0 is locally implemented as a Seller-only review-and-send workflow and is under release QA. |
