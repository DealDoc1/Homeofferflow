...
| Local regression suite | All tests green | Pass — 384 tests (including brokerage invite acceptance, expiry coverage, live-QA runbook, profile-load failure coverage, release-gate checks, and AI-calibration record validation) |
