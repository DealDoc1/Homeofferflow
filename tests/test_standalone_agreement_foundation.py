...
class StandaloneAgreementFoundationTests(unittest.TestCase):
    ...
    def test_agent_ui_requires_an_approved_source_and_prepares_reviewable_documents(self):
        ...
        self.assertIn("Choose the broker or broker associate who will sign this agreement.", HTML)
        self.assertIn("Choose the broker or broker associate who will sign this notice.", HTML)
        self.assertIn("Choose whether the broker or broker associate will acknowledge this showing form.", HTML)
