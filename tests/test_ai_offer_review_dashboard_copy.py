...
class AiOfferReviewDashboardCopyTests(unittest.TestCase):
    def test_dashboard_describes_the_available_review_without_overclaiming(self):
        self.assertIn("Review strengths, risk points, and questions to verify before sending a packet.", INDEX_HTML)
        self.assertIn("Open Offer Review for a fuller market-and-terms review.", INDEX_HTML)
    ...
    def test_dashboard_no_longer_calls_live_review_a_future_placeholder(self):
        ...
        self.assertNotIn("Future AI Checklist", INDEX_HTML)
