...
class PwaShareTargetTests(unittest.TestCase):
    ...
    def test_shared_context_has_a_low_friction_buyer_offer_handoff_without_url_prefill(self):
        ...
        self.assertIn("window.setAudience?.('homebuyer', { presentationOnly: true })", SHARE)
    ...
    def test_shared_context_has_a_neutral_agent_transaction_chooser_handoff(self):
        ...
        self.assertIn('homeofferflow-shell-v74', (ROOT / 'service-worker.js').read_text(encoding='utf-8'))
