...
class TechnicalSeoTests(unittest.TestCase):
    ...
    def test_sitemap_keeps_revenue_landing_pages_discoverable(self):
        for path in ("/buyers", "/agents", "/investors", "/sellers", "/partners", "/directory", "/texas-lease-offer-workflow", "/texas-listing-workflow", "/texas-agent-form-library", "/texas-seller-financing-guide"):
