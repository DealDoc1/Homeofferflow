...
class SellerDisclosureSigningPathTests(unittest.TestCase):
    ...
    def test_backend_requires_reviewed_draft_and_uses_packet_offset(self):
        ...
        self.assertIn("_deliver_tracked_signwell_request", signing)
        self.assertIn("_signwell_document_matches_signing_request", source)
        self.assertNotIn("client.delete", signing)
