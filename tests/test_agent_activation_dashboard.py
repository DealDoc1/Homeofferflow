...
class AgentActivationDashboardTests(unittest.TestCase):
    ...
    def test_transaction_interview_recommends_a_package_before_opening_a_workspace(self):
        ...
        self.assertIn("Request a lease form", HTML)
        self.assertNotIn("Prepare a lease addendum", HTML)
        ...
        self.assertIn("followUp.addEventListener('keydown', event => { if (event.key === 'Escape') closeFollowUp(); });", HTML)
    ...
    def test_lease_representation_choice_waits_for_its_explicit_approved_source_without_a_second_click(self):
        ...
        self.assertIn("Checking the approved form for your selected draft…", HTML)
        ...
        self.assertIn("Approved form ready. Opening your selected private draft…", HTML)
