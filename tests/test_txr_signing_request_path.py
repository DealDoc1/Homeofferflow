...
class TxrSigningRequestPathTests(unittest.TestCase):
    ...
    def test_temporary_provider_delivery_failure_keeps_the_draft_retryable(self):
        ...
        self.assertIn("Private document creation failed", source)
        self.assertIn("except signwell_delivery.DeliveryPending as exc:", source)
        self.assertIn('"deliveryUnconfirmed": True', source)
