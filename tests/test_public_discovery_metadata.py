...
class PublicDiscoveryMetadataTests(unittest.TestCase):
    ...
    def test_agent_workspace_page_is_indexable_and_routes_to_passwordless_sign_in(self):
        ...
        self.assertIn('Seller planning', AGENTS)
        ...
        self.assertIn('the queue identifies the selected signer and requires explicit recipient confirmation before a document is sent.', AGENTS)
