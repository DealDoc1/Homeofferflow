...
def build_pages_data(
    ...
    pages[9] = [
        ...
        (51,  150, ck(has_buyer_agent and broker_fee_type == "amount"), "check_small"),
        (66,  150, fmt_money(broker_fee_amount) if has_buyer_agent and broker_fee_type == "amount" else "", 8),
        (184, 150, ck(has_buyer_agent and broker_fee_type == "percent"), "check_small"),
        (202, 150, str(broker_fee_percent) if has_buyer_agent and broker_fee_type == "percent" else "", 8),
