...
def build_pages_data(
    ...
    pages[9] = [
        ...
        # Broker fee disclosure at top of Broker Information page.
        # Only fill if there is a previous, separate agreement for Listing Broker to pay Other Broker.
        (51,  688, ck(has_buyer_agent and broker_fee_type == "amount"), "check_small"),
        (66,  688, fmt_money(broker_fee_amount) if has_buyer_agent and broker_fee_type == "amount" else "", 8),
        (184, 688, ck(has_buyer_agent and broker_fee_type == "percent"), "check_small"),
        (202, 688, str(broker_fee_percent) if has_buyer_agent and broker_fee_type == "percent" else "", 8),
