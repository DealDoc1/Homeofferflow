    ...
    admin_html = f"""
      <div style="font-family:Arial,sans-serif;max-width:720px;margin:0 auto;color:#1a1a1a;">
        ...
        <table style="border-collapse:collapse;width:100%;margin-top:0.5rem;">
          ...
          <tr><td style="padding:8px;border:1px solid #ddd;"><strong>Home Warranty / Residential Service Contract</strong></td><td style="padding:8px;border:1px solid #ddd;">{html_escape(money_display(offer.get("homeWarrantyAmount") or offer.get("residentialServiceAmount")))}</td></tr>
