...
def create_signwell_signature_request(offer, pdf_bytes):
    ...
    try:
        ...
        # Do NOT fall back to SignWell's generic signature page.
        # For TREC/promulgated forms, signatures/initials must be placed on the actual form pages.
        return {
            "enabled": True,
            "ok": False,
            "mode": "coordinate_fields_failed",
            "test_mode": SIGNWELL_TEST_MODE,
